...
<body>
    ...
    const DONORS = [
        ...
        { name: 'Omar F.',    city: 'Detroit, MI',       amount: 75,  initials: 'OF' },
        { name: 'Priya N.',   city: 'Boston, MA',        amount: 10,  initials: 'PN' },
        { name: 'Carlos R.',  city: 'Miami, FL',         amount: 200, initials: 'CR' },
        { name: 'Yeona K.',   city: 'Portland, OR',      amount: 50,  initials: 'YK' },
        { name: 'Tamara B.',  city: 'Philadelphia, PA',  amount: 25,  initials: 'TB' },
        { name: 'Jake W.',    city: 'Denver, CO',        amount: 150, initials: 'JW' },
        { name: 'Aisha P.',   city: 'Atlanta, GA',       amount: 40,  initials: 'AP' },
        { name: 'Ethan C.',   city: 'Minneapolis, MN',   amount: 30,  initials: 'EC' },
        { name: 'Luisa D.',   city: 'San Antonio, TX',   amount: 20,  initials: 'LD' },
        { name: 'Ryan S.',    city: 'Phoenix, AZ',       amount: 50,  initials: 'RS' },
        { name: 'Nina V.',    city: 'New York, NY',      amount: 250, initials: 'NV' },
        { name: 'Andre M.',   city: 'Baltimore, MD',     amount: 35,  initials: 'AM' },
        { name: 'Sophie H.',  city: 'San Francisco, CA', amount: 100, initials: 'SH' },
        { name: 'Marcus J.',  city: 'Houston, TX',       amount: 45,  initials: 'MJ' },
        { name: 'Elena R.',   city: 'Las Vegas, NV',     amount: 60,  initials: 'ER' },
        { name: 'Kwame O.',   city: 'Columbus, OH',      amount: 25,  initials: 'KO' },
        { name: 'Vivian L.',  city: 'Nashville, TN',     amount: 85,  initials: 'VL' },
        { name: 'Felix A.',   city: 'Sacramento, CA',    amount: 15,  initials: 'FA' },
        { name: 'Mei W.',     city: 'San Jose, CA',      amount: 120, initials: 'MW' },
        { name: 'Derek P.',   city: 'Kansas City, MO',   amount: 40,  initials: 'DP' },
    ];
