...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="table-card p-4">
            <h6 class="fw-semibold mb-4">Edit: {{ $profile->name }}</h6>
            <form action="{{ route('admin.names.update', $profile) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="writeup" rows="10"
                              ...
                              placeholder="Write the content for this name...">{{ old('writeup', $profile->writeup) }}</textarea>
